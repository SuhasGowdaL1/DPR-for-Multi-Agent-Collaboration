...
function labelForArtifact(name, href) {
  ...
  if (name === 'callgraphDiffHtml') return 'Callgraph diff';
  if (name === 'callgraphDiff') return 'Callgraph diff JSON';
...
function App() {
  ...
  const [diffArgs, setDiffArgs] = useState([]);
    ...
    <main className="app">
      ...
      <section className="workspace">
        ...
        <div className="panel settingsPanel">
          ...
          <ChipInput label="callgraph_diff" values={diffArgs} onChange={setDiffArgs} placeholder="--no-html" />
        </div>
